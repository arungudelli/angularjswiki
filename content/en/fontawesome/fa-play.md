+++
title="fa-play icon in font awesome icons"
summary="fa-play icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-play,f04b,fa-play"]
...
fa-play icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-play</td><td>fa-play</td><td>f04b</td></tr></tbody></table></div>
...
To display fa-play icon add predefined class name i.e.,fa-play (with prefix fa-) to the 'i' tag.
...
## Change fa-play icon size
To increase fa-play font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-play.
...
## Pull fa-play icon To the right
...
## Animate fa-play icon using fa-spin
...
## Animate fa-play icon with steps
...
## Rotate fa-play Icon using fa-rotate-x
...
## Flip fa-play Icon using fa-flip-*
...
## Combine fa-play icon with other font awesome icons
