...
linktitle = 'fa-house-chimney-user'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `House-Chimney-User` font awesome icon.
```
...
## Change `House-Chimney-User` font awesome icon size
