...
+++
title='Deskpro font awesome icon Usage,CSS Class Name,SVG & CSS Content Code'
summary = 'Deskpro font awesome icon CSS class is fa-deskpro & CSS Content Code is  \f38f'
keywords =['Deskpro, \f38f,fa-deskpro']
