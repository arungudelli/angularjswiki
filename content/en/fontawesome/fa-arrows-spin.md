...
## Change `Arrows-Spin` font awesome icon size
To increase `Arrows-Spin` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e4bb.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-arrows-spin fa-lg'>fa-lg</i><br/>
<i class='fas fa-arrows-spin fa-2x'>fa-2x</i><br/>
<i class='fas fa-arrows-spin fa-3x'>fa-3x</i><br/>
<i class='fas fa-arrows-spin fa-4x'>fa-4x</i><br/>
<i class='fas fa-arrows-spin fa-5x'>fa-5x</i><br/>
...
## `Arrows-Spin` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Arrows-Spin` icon and `home` icon may not have same height and width.
