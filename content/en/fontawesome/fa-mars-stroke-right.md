...
linktitle = 'fa-mars-stroke-right'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Mars-Stroke-Right` font awesome icon.
```
...
## Change `Mars-Stroke-Right` font awesome icon size
