...
linktitle = 'fa-arrows-turn-to-dots'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrows-Turn-To-Dots` font awesome icon.
```
...
## Change `Arrows-Turn-To-Dots` font awesome icon size
