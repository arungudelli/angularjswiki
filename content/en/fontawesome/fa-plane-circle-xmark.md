...
linktitle = 'fa-plane-circle-xmark'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Plane-Circle-Xmark` font awesome icon.
```
...
## Change `Plane-Circle-Xmark` font awesome icon size
To increase `Plane-Circle-Xmark` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e557.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-plane-circle-xmark fa-lg'>fa-lg</i><br/>
<i class='fas fa-plane-circle-xmark fa-2x'>fa-2x</i><br/>
<i class='fas fa-plane-circle-xmark fa-3x'>fa-3x</i><br/>
<i class='fas fa-plane-circle-xmark fa-4x'>fa-4x</i><br/>
<i class='fas fa-plane-circle-xmark fa-5x'>fa-5x</i><br/>
...
## `Plane-Circle-Xmark` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Plane-Circle-Xmark` icon and `home` icon may not have same height and width.

So to display two icons with fixed width and height we can use `fa-fw` class.
```
<i style='border:1px solid;' class='fas fa-plane-circle-xmark fa-fw fa-3x'></i>Fixed Width<i style='border:1px solid;' class='fas fa-plane-circle-xmark fa-3x'></i>Normal<br/>
...
## Animate `Plane-Circle-Xmark` font awesome icon
...
## Flip `Plane-Circle-Xmark` font awesome icon
