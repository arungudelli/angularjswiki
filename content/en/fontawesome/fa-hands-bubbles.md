...
Use the following icon SVG to display `Hands-Bubbles` font awesome icon.
```
...
For example `Hands-Bubbles` icon and `home` icon may not have same height and width.
