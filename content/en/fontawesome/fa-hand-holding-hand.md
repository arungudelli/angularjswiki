...
linktitle = 'fa-hand-holding-hand'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Hand-Holding-Hand` font awesome icon.
```
...
## Change `Hand-Holding-Hand` font awesome icon size
