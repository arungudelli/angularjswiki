...
linktitle = 'fa-person-military-rifle'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Person-Military-Rifle` font awesome icon SVG 
...
## Change `Person-Military-Rifle` font awesome icon size
To increase `Person-Military-Rifle` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e54b.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-person-military-rifle fa-lg'>fa-lg</i><br/>
<i class='fas fa-person-military-rifle fa-2x'>fa-2x</i><br/>
<i class='fas fa-person-military-rifle fa-3x'>fa-3x</i><br/>
<i class='fas fa-person-military-rifle fa-4x'>fa-4x</i><br/>
<i class='fas fa-person-military-rifle fa-5x'>fa-5x</i><br/>
...
## `Person-Military-Rifle` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Person-Military-Rifle` icon and `home` icon may not have same height and width.
