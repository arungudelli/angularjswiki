...
linktitle = 'fa-person-walking-with-cane'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Person-Walking-With-Cane` font awesome icon SVG 
...
## Change `Person-Walking-With-Cane` font awesome icon size
To increase `Person-Walking-With-Cane` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f29d.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-person-walking-with-cane fa-lg'>fa-lg</i><br/>
<i class='fas fa-person-walking-with-cane fa-2x'>fa-2x</i><br/>
<i class='fas fa-person-walking-with-cane fa-3x'>fa-3x</i><br/>
<i class='fas fa-person-walking-with-cane fa-4x'>fa-4x</i><br/>
<i class='fas fa-person-walking-with-cane fa-5x'>fa-5x</i><br/>
...
## `Person-Walking-With-Cane` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Person-Walking-With-Cane` icon and `home` icon may not have same height and width.
