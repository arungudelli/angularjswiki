+++
title="fa-creative-commons-sa icon in font awesome icons"
summary="fa-creative-commons-sa icon in font awesome icons is part of brand (fab) icons"
keywords=["fa-creative-commons-sa,f4ef,fa-creative-commons-sa"]
...
fa-creative-commons-sa icon in font awesome icons is part of brand (fab) icons

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-creative-commons-sa</td><td>fa-creative-commons-sa</td><td>f4ef</td></tr></tbody></table></div>


{{% toc %}}


## fa-creative-commons-sa icon Usage

To display fa-creative-commons-sa icon add predefined class name i.e.,fa-creative-commons-sa (with prefix fa-) to the 'i' tag.
...
## Change fa-creative-commons-sa icon size
To increase fa-creative-commons-sa font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-creative-commons-sa.
...
## fa-creative-commons-sa Icon with Fixed Width 
...
## fa-creative-commons-sa Icon Border 
...
## Pull fa-creative-commons-sa icon To the left
...
## Pull fa-creative-commons-sa icon To the right
...
## Animate fa-creative-commons-sa icon using fa-spin
...
## Animate fa-creative-commons-sa icon with steps
...
## Rotate fa-creative-commons-sa Icon using fa-rotate-x
...
## Flip fa-creative-commons-sa Icon using fa-flip-*
...
## Combine fa-creative-commons-sa icon with other font awesome icons
