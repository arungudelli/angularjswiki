...
linktitle = 'fa-building-circle-xmark'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Building-Circle-Xmark` font awesome icon SVG 
...
For example `Building-Circle-Xmark` icon and `home` icon may not have same height and width.
