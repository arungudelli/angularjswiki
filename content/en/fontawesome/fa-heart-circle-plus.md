...
linktitle = 'fa-heart-circle-plus'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Heart-Circle-Plus` font awesome icon.
```
...
## Change `Heart-Circle-Plus` font awesome icon size
