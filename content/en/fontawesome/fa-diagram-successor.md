...
linktitle = 'fa-diagram-successor'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Diagram-Successor` font awesome icon.
```
...
## Change `Diagram-Successor` font awesome icon size
