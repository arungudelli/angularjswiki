...
linktitle = 'fa-road-circle-check'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Road-Circle-Check` font awesome icon.
```
...
## Change `Road-Circle-Check` font awesome icon size
