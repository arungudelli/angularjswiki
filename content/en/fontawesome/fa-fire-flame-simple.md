...
next = 'fa-fire'
linktitle = 'fa-fire-flame-simple'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Fire-Flame-Simple` font awesome icon.
```
...
## Change `Fire-Flame-Simple` font awesome icon size
