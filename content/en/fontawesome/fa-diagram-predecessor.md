...
linktitle = 'fa-diagram-predecessor'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Diagram-Predecessor` font awesome icon.
```
...
## Change `Diagram-Predecessor` font awesome icon size
