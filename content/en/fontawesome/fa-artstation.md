+++
title="fa-artstation icon in font awesome icons"
summary="fa-artstation icon in font awesome icons is part of brand (fab) icons"
keywords=["fa-artstation,f77a,fa-artstation"]
...
fa-artstation icon in font awesome icons is part of brand (fab) icons

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-artstation</td><td>fa-artstation</td><td>f77a</td></tr></tbody></table></div>


{{% toc %}}


## fa-artstation icon Usage

To display fa-artstation icon add predefined class name i.e.,fa-artstation (with prefix fa-) to the 'i' tag.
...
## Change fa-artstation icon size
To increase fa-artstation font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-artstation.
...
## fa-artstation Icon with Fixed Width 
...
## Pull fa-artstation icon To the left
...
## Pull fa-artstation icon To the right
...
## Animate fa-artstation icon using fa-spin
...
## Animate fa-artstation icon with steps
...
## Rotate fa-artstation Icon using fa-rotate-x
...
## Flip fa-artstation Icon using fa-flip-*
...
## Combine fa-artstation icon with other font awesome icons
