...
Use the following icon SVG to display `Arrows-To-Dot` font awesome icon.
```
...
## Change `Arrows-To-Dot` font awesome icon size
To increase `Arrows-To-Dot` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e4be.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-arrows-to-dot fa-lg'>fa-lg</i><br/>
<i class='fas fa-arrows-to-dot fa-2x'>fa-2x</i><br/>
<i class='fas fa-arrows-to-dot fa-3x'>fa-3x</i><br/>
<i class='fas fa-arrows-to-dot fa-4x'>fa-4x</i><br/>
<i class='fas fa-arrows-to-dot fa-5x'>fa-5x</i><br/>
...
## `Arrows-To-Dot` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Arrows-To-Dot` icon and `home` icon may not have same height and width.
...
## Flip `Arrows-To-Dot` font awesome icon
