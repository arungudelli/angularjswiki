...
prev = 'fa-code-merge'
next = 'fa-code'
linktitle = 'fa-code-pull-request'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Code-Pull-Request` font awesome icon.
```
...
## Change `Code-Pull-Request` font awesome icon size
To increase `Code-Pull-Request` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e13c.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-code-pull-request fa-lg'>fa-lg</i><br/>
<i class='fas fa-code-pull-request fa-2x'>fa-2x</i><br/>
<i class='fas fa-code-pull-request fa-3x'>fa-3x</i><br/>
<i class='fas fa-code-pull-request fa-4x'>fa-4x</i><br/>
<i class='fas fa-code-pull-request fa-5x'>fa-5x</i><br/>
...
## `Code-Pull-Request` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Code-Pull-Request` icon and `home` icon may not have same height and width.
...
## Flip `Code-Pull-Request` font awesome icon
