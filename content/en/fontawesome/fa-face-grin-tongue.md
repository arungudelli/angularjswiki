...
## `Face-Grin-Tongue` font awesome icon SVG 
...
## Change `Face-Grin-Tongue` font awesome icon size
To increase `Face-Grin-Tongue` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f589.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-face-grin-tongue fa-lg'>fa-lg</i><br/>
<i class='fas fa-face-grin-tongue fa-2x'>fa-2x</i><br/>
<i class='fas fa-face-grin-tongue fa-3x'>fa-3x</i><br/>
<i class='fas fa-face-grin-tongue fa-4x'>fa-4x</i><br/>
<i class='fas fa-face-grin-tongue fa-5x'>fa-5x</i><br/>
...
## `Face-Grin-Tongue` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Face-Grin-Tongue` icon and `home` icon may not have same height and width.

So to display two icons with fixed width and height we can use `fa-fw` class.
```
<i style='border:1px solid;' class='fas fa-face-grin-tongue fa-fw fa-3x'></i>Fixed Width<i style='border:1px solid;' class='fas fa-face-grin-tongue fa-3x'></i>Normal<br/>
...
## Flip `Face-Grin-Tongue` font awesome icon
