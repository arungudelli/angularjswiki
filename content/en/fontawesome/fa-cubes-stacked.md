...
Use the following icon SVG to display `Cubes-Stacked` font awesome icon.
```
...
## Change `Cubes-Stacked` font awesome icon size
To increase `Cubes-Stacked` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e4e6.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-cubes-stacked fa-lg'>fa-lg</i><br/>
<i class='fas fa-cubes-stacked fa-2x'>fa-2x</i><br/>
<i class='fas fa-cubes-stacked fa-3x'>fa-3x</i><br/>
<i class='fas fa-cubes-stacked fa-4x'>fa-4x</i><br/>
<i class='fas fa-cubes-stacked fa-5x'>fa-5x</i><br/>
...
## `Cubes-Stacked` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Cubes-Stacked` icon and `home` icon may not have same height and width.
...
## Flip `Cubes-Stacked` font awesome icon
