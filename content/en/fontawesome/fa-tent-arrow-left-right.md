...
linktitle = 'fa-tent-arrow-left-right'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Tent-Arrow-Left-Right` font awesome icon SVG 
...
## Change `Tent-Arrow-Left-Right` font awesome icon size
To increase `Tent-Arrow-Left-Right` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e57f.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-tent-arrow-left-right fa-lg'>fa-lg</i><br/>
<i class='fas fa-tent-arrow-left-right fa-2x'>fa-2x</i><br/>
<i class='fas fa-tent-arrow-left-right fa-3x'>fa-3x</i><br/>
<i class='fas fa-tent-arrow-left-right fa-4x'>fa-4x</i><br/>
<i class='fas fa-tent-arrow-left-right fa-5x'>fa-5x</i><br/>
...
## `Tent-Arrow-Left-Right` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Tent-Arrow-Left-Right` icon and `home` icon may not have same height and width.

So to display two icons with fixed width and height we can use `fa-fw` class.
```
<i style='border:1px solid;' class='fas fa-tent-arrow-left-right fa-fw fa-3x'></i>Fixed Width<i style='border:1px solid;' class='fas fa-tent-arrow-left-right fa-3x'></i>Normal<br/>
...
## Animate `Tent-Arrow-Left-Right` font awesome icon
...
## Flip `Tent-Arrow-Left-Right` font awesome icon
