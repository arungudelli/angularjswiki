...
linktitle = 'fa-heart-circle-check'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Heart-Circle-Check` font awesome icon.
```
...
## Change `Heart-Circle-Check` font awesome icon size
