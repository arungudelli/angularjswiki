+++
title="Laravel icon in font awesome icons"
summary="Laravel icon represented as fa-laravel in font awesome icons is part of brand (fab) icons"
keywords=["fa-laravel,f3bd,Laravel"]
...
Laravel icon represented as fa-laravel in font awesome icons is part of brand (fab) icons

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>Laravel</td><td>fa-laravel</td><td>f3bd</td></tr></tbody></table></div>



## Laravel icon Usage

To display Laravel icon add predefined class name i.e.,fa-laravel (with prefix fa-) to the 'i' tag.
...
## Change Laravel icon size
To increase Laravel font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-laravel.
...
## Pull Laravel icon To the right
...
## Animate Laravel icon using fa-spin
...
## Animate Laravel icon with steps
...
## Rotate Laravel Icon using fa-rotate-x
...
## Flip Laravel Icon using fa-flip-*
...
## Combine Laravel icon with other font awesome icons
