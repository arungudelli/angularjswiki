...
linktitle = 'fa-champagne-glasses'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Champagne-Glasses` font awesome icon.
```
...
## Change `Champagne-Glasses` font awesome icon size
