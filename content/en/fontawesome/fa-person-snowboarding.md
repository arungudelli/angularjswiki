...
linktitle = 'fa-person-snowboarding'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Person-Snowboarding` font awesome icon.
```
...
## Change `Person-Snowboarding` font awesome icon size
To increase `Person-Snowboarding` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f7ce.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-person-snowboarding fa-lg'>fa-lg</i><br/>
<i class='fas fa-person-snowboarding fa-2x'>fa-2x</i><br/>
<i class='fas fa-person-snowboarding fa-3x'>fa-3x</i><br/>
<i class='fas fa-person-snowboarding fa-4x'>fa-4x</i><br/>
<i class='fas fa-person-snowboarding fa-5x'>fa-5x</i><br/>
...
## `Person-Snowboarding` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Person-Snowboarding` icon and `home` icon may not have same height and width.
...
## Flip `Person-Snowboarding` font awesome icon
