...
linktitle = 'fa-temperature-arrow-down'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Temperature-Arrow-Down` font awesome icon SVG 
...
## Change `Temperature-Arrow-Down` font awesome icon size
To increase `Temperature-Arrow-Down` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e03f.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-temperature-arrow-down fa-lg'>fa-lg</i><br/>
<i class='fas fa-temperature-arrow-down fa-2x'>fa-2x</i><br/>
<i class='fas fa-temperature-arrow-down fa-3x'>fa-3x</i><br/>
<i class='fas fa-temperature-arrow-down fa-4x'>fa-4x</i><br/>
<i class='fas fa-temperature-arrow-down fa-5x'>fa-5x</i><br/>
...
## `Temperature-Arrow-Down` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Temperature-Arrow-Down` icon and `home` icon may not have same height and width.
