...
Use the following icon SVG to display `Watchman-Monitoring` font awesome icon.
```
...
## Change `Watchman-Monitoring` font awesome icon size
To increase `Watchman-Monitoring` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e087.
Increase in icon size will be relative to their parent container.
```
<i class='fab fa-watchman-monitoring fa-lg'>fa-lg</i><br/>
<i class='fab fa-watchman-monitoring fa-2x'>fa-2x</i><br/>
<i class='fab fa-watchman-monitoring fa-3x'>fa-3x</i><br/>
<i class='fab fa-watchman-monitoring fa-4x'>fa-4x</i><br/>
<i class='fab fa-watchman-monitoring fa-5x'>fa-5x</i><br/>
...
## `Watchman-Monitoring` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Watchman-Monitoring` icon and `home` icon may not have same height and width.
...
## Flip `Watchman-Monitoring` font awesome icon
