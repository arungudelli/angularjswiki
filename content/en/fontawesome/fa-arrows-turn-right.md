...
linktitle = 'fa-arrows-turn-right'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrows-Turn-Right` font awesome icon.
```
...
## Change `Arrows-Turn-Right` font awesome icon size
