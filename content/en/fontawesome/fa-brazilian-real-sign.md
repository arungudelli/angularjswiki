...
Use the following icon SVG to display `Brazilian-Real-Sign` font awesome icon.
```
...
## Change `Brazilian-Real-Sign` font awesome icon size
To increase `Brazilian-Real-Sign` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e46c.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-brazilian-real-sign fa-lg'>fa-lg</i><br/>
<i class='fas fa-brazilian-real-sign fa-2x'>fa-2x</i><br/>
<i class='fas fa-brazilian-real-sign fa-3x'>fa-3x</i><br/>
<i class='fas fa-brazilian-real-sign fa-4x'>fa-4x</i><br/>
<i class='fas fa-brazilian-real-sign fa-5x'>fa-5x</i><br/>
...
## `Brazilian-Real-Sign` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Brazilian-Real-Sign` icon and `home` icon may not have same height and width.
...
## Flip `Brazilian-Real-Sign` font awesome icon
