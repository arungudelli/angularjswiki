...
+++
title='Biohazard font awesome icon Usage,CSS Class Name,SVG & CSS Content Code'
summary = 'Biohazard font awesome icon CSS class is fa-biohazard & CSS Content Code is  \f780'
keywords =['Biohazard, \f780,fa-biohazard']
...
categories =['faicons']
prev = 'fa-binoculars'
next = 'fa-bitcoin-sign'
linktitle = 'fa-biohazard_1'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'true'
...
`Biohazard` icon has 1 icon style i.e.,solid. 
...
To increase `Biohazard` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f780.
