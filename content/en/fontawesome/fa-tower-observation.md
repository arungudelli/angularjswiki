...
prev = 'fa-tower-cell'
next = 'fa-tractor'
linktitle = 'fa-tower-observation'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Tower-Observation` font awesome icon.
```
...
## Change `Tower-Observation` font awesome icon size
