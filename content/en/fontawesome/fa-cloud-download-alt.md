+++
title="Cloud Download Alt icon in font awesome icons"
summary="Cloud Download Alt icon represented as fa-cloud-download-alt in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-cloud-download-alt,f381,Cloud Download Alt"]
...
Cloud Download Alt icon represented as fa-cloud-download-alt in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>Cloud Download Alt</td><td>fa-cloud-download-alt</td><td>f381</td></tr></tbody></table></div>



## Cloud Download Alt icon Usage

To display Cloud Download Alt icon add predefined class name i.e.,fa-cloud-download-alt (with prefix fa-) to the 'i' tag.
...
## Change Cloud Download Alt icon size
To increase Cloud Download Alt font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-cloud-download-alt.
...
## Cloud Download Alt Icon with Fixed Width 
...
## Cloud Download Alt Icon Border 
...
## Pull Cloud Download Alt icon To the left
...
## Pull Cloud Download Alt icon To the right
...
## Animate Cloud Download Alt icon using fa-spin
...
## Animate Cloud Download Alt icon with steps
...
## Rotate Cloud Download Alt Icon using fa-rotate-x
...
## Flip Cloud Download Alt Icon using fa-flip-*
...
## Combine Cloud Download Alt icon with other font awesome icons
