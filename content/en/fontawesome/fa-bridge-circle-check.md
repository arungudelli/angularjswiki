...
linktitle = 'fa-bridge-circle-check'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Bridge-Circle-Check` font awesome icon.
```
...
## Change `Bridge-Circle-Check` font awesome icon size
