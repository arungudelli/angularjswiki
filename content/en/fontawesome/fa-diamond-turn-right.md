...
next = 'fa-diamond'
linktitle = 'fa-diamond-turn-right'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Diamond-Turn-Right` font awesome icon.
```
...
## Change `Diamond-Turn-Right` font awesome icon size
