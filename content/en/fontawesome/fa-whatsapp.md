...
+++
title='Whatsapp font awesome icon Usage,CSS Class Name,SVG & CSS Content Code'
summary = 'Whatsapp font awesome icon CSS class is fa-whatsapp & CSS Content Code is  \f232'
keywords =['Whatsapp, \f232,fa-whatsapp']
...
`Whatsapp` icon has 1 icon style i.e.,brands. 
...
To increase `Whatsapp` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f232.
