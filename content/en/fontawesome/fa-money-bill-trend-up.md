...
linktitle = 'fa-money-bill-trend-up'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Money-Bill-Trend-Up` font awesome icon.
```
...
## Change `Money-Bill-Trend-Up` font awesome icon size
