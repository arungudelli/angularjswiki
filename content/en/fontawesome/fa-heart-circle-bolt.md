...
linktitle = 'fa-heart-circle-bolt'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Heart-Circle-Bolt` font awesome icon.
```
...
## Change `Heart-Circle-Bolt` font awesome icon size
