...
linktitle = 'fa-person-walking-dashed-line-arrow-right'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Person-Walking-Dashed-Line-Arrow-Right` font awesome icon SVG 
...
## `Person-Walking-Dashed-Line-Arrow-Right` font awesome icon with Fixed Width
