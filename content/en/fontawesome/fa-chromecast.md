...
+++
title='Chromecast font awesome icon Usage,CSS Class Name,SVG & CSS Content Code'
summary = 'Chromecast font awesome icon CSS class is fa-chromecast & CSS Content Code is f838'
keywords =['Chromecast, \f838,fa-chromecast']
...
`Chromecast` icon has 1 icon style i.e.,brands. 
...
To increase `Chromecast` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f838.
