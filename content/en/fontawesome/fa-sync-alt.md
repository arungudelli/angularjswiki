+++
title="Sync Alt icon in font awesome icons"
summary="Sync Alt icon represented as fa-sync-alt in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-sync-alt,f2f1,Sync Alt"]
...
Sync Alt icon represented as fa-sync-alt in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>Sync Alt</td><td>fa-sync-alt</td><td>f2f1</td></tr></tbody></table></div>



## Sync Alt icon Usage

To display Sync Alt icon add predefined class name i.e.,fa-sync-alt (with prefix fa-) to the 'i' tag.
...
## Change Sync Alt icon size
To increase Sync Alt font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-sync-alt.
...
## Sync Alt Icon with Fixed Width 
...
## Pull Sync Alt icon To the left
...
## Pull Sync Alt icon To the right
...
## Animate Sync Alt icon using fa-spin
...
## Animate Sync Alt icon with steps
...
## Rotate Sync Alt Icon using fa-rotate-x
...
## Flip Sync Alt Icon using fa-flip-*
...
## Combine Sync Alt icon with other font awesome icons
