...
linktitle = 'fa-arrow-rotate-right'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrow-Rotate-Right` font awesome icon.
```
...
## Change `Arrow-Rotate-Right` font awesome icon size
