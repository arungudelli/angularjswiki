...
linktitle = 'fa-cloud-showers-water'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Cloud-Showers-Water` font awesome icon.
```
...
For example `Cloud-Showers-Water` icon and `home` icon may not have same height and width.
