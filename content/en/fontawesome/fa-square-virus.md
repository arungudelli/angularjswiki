...
Use the following icon SVG to display `Square-Virus` font awesome icon.
```
...
## Change `Square-Virus` font awesome icon size
To increase `Square-Virus` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e578.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-square-virus fa-lg'>fa-lg</i><br/>
<i class='fas fa-square-virus fa-2x'>fa-2x</i><br/>
<i class='fas fa-square-virus fa-3x'>fa-3x</i><br/>
<i class='fas fa-square-virus fa-4x'>fa-4x</i><br/>
<i class='fas fa-square-virus fa-5x'>fa-5x</i><br/>
...
## `Square-Virus` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Square-Virus` icon and `home` icon may not have same height and width.
...
## Flip `Square-Virus` font awesome icon
