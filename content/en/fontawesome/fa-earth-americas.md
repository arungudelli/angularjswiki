...
Use the following icon SVG to display `Earth-Americas` font awesome icon.
```
...
## Change `Earth-Americas` font awesome icon size
To increase `Earth-Americas` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f57d.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-earth-americas fa-lg'>fa-lg</i><br/>
<i class='fas fa-earth-americas fa-2x'>fa-2x</i><br/>
<i class='fas fa-earth-americas fa-3x'>fa-3x</i><br/>
<i class='fas fa-earth-americas fa-4x'>fa-4x</i><br/>
<i class='fas fa-earth-americas fa-5x'>fa-5x</i><br/>
...
## `Earth-Americas` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Earth-Americas` icon and `home` icon may not have same height and width.
...
## Flip `Earth-Americas` font awesome icon
