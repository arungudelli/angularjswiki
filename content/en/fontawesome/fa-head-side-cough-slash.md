+++
title="fa-head-side-cough-slash icon in font awesome icons"
summary="fa-head-side-cough-slash icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-head-side-cough-slash,f962,fa-head-side-cough-slash"]
...
fa-head-side-cough-slash icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-head-side-cough-slash</td><td>fa-head-side-cough-slash</td><td>f962</td></tr></tbody></table></div>


{{% toc %}}


## fa-head-side-cough-slash icon Usage

To display fa-head-side-cough-slash icon add predefined class name i.e.,fa-head-side-cough-slash (with prefix fa-) to the 'i' tag.
...
## Change fa-head-side-cough-slash icon size
To increase fa-head-side-cough-slash font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-head-side-cough-slash.
...
## fa-head-side-cough-slash Icon with Fixed Width 
...
## fa-head-side-cough-slash Icon Border 
...
## Pull fa-head-side-cough-slash icon To the left
...
## Pull fa-head-side-cough-slash icon To the right
...
## Animate fa-head-side-cough-slash icon using fa-spin
...
## Animate fa-head-side-cough-slash icon with steps
...
## Rotate fa-head-side-cough-slash Icon using fa-rotate-x
...
## Flip fa-head-side-cough-slash Icon using fa-flip-*
...
## Combine fa-head-side-cough-slash icon with other font awesome icons
