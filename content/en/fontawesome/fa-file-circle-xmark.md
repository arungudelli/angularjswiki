...
next = 'fa-file-code'
linktitle = 'fa-file-circle-xmark'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `File-Circle-Xmark` font awesome icon.
```
...
## Change `File-Circle-Xmark` font awesome icon size
