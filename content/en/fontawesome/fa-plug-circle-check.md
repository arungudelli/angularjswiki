...
linktitle = 'fa-plug-circle-check'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Plug-Circle-Check` font awesome icon.
```
...
## Change `Plug-Circle-Check` font awesome icon size
