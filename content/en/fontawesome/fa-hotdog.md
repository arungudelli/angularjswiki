+++
title="Hotdog icon in font awesome icons"
summary="Hotdog icon represented as fa-hotdog in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-hotdog,f80f,Hotdog"]
...
Hotdog icon represented as fa-hotdog in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>Hotdog</td><td>fa-hotdog</td><td>f80f</td></tr></tbody></table></div>



## Hotdog icon Usage

To display Hotdog icon add predefined class name i.e.,fa-hotdog (with prefix fa-) to the 'i' tag.
...
## Change Hotdog icon size
To increase Hotdog font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-hotdog.
...
## Animate Hotdog icon using fa-spin
...
## Animate Hotdog icon with steps
...
## Rotate Hotdog Icon using fa-rotate-x
...
## Flip Hotdog Icon using fa-flip-*
...
## Combine Hotdog icon with other font awesome icons
