...
prev = 'fa-tty'
next = 'fa-turn-down'
linktitle = 'fa-turkish-lira-sign'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Turkish-Lira-Sign` font awesome icon.
```
...
## Change `Turkish-Lira-Sign` font awesome icon size
