...
Use the following icon SVG to display `Mobile-Retro` font awesome icon.
```
...
## Change `Mobile-Retro` font awesome icon size
To increase `Mobile-Retro` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e527.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-mobile-retro fa-lg'>fa-lg</i><br/>
<i class='fas fa-mobile-retro fa-2x'>fa-2x</i><br/>
<i class='fas fa-mobile-retro fa-3x'>fa-3x</i><br/>
<i class='fas fa-mobile-retro fa-4x'>fa-4x</i><br/>
<i class='fas fa-mobile-retro fa-5x'>fa-5x</i><br/>
...
## `Mobile-Retro` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Mobile-Retro` icon and `home` icon may not have same height and width.
...
## Flip `Mobile-Retro` font awesome icon
