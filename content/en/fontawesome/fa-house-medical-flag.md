...
linktitle = 'fa-house-medical-flag'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `House-Medical-Flag` font awesome icon.
```
...
## Change `House-Medical-Flag` font awesome icon size
