...
`Khanda` font awesome icon is part of solid icons. 



{{%toc%}}
## `Khanda` font awesome icon usage
We can display `Khanda` font awesome icon using 3 different ways depending upon our requirement.
...
## `Khanda` font awesome icon CSS class name

To display `Khanda` font awesome icon, add predefined class name i.e.,`fa-khanda` (with prefix `fa-`) to the `i` tag. 

And we need to add corresponding font awesome icon style for the `Khanda` icon.


`Khanda` icon has 1 icon style i.e.,solid. 
...
## `Khanda` font awesome icon CSS Content Code 

We can display `Khanda` font awesome icon using it's CSS Content Code ` \f66d` 

Use the following HTML code 

```
<li><span class='Khanda fontawesomeicon'></span>Khanda</li>
```
...
## Change `Khanda` font awesome icon size
To increase `Khanda` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f66d.
...
## `Khanda` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Khanda` icon and `home` icon may not have same height and width.

So to display two icons with fixed width and height we can use `fa-fw` class.
```
<i style='border:1px solid;' class='fas fa-khanda fa-fw fa-3x'></i>Fixed Width<i style='border:1px solid;' class='fas fa-khanda fa-3x'></i>Normal<br/>
...
## `Khanda` font awesome icon Border
To add border to `Khanda` font awesome icon, use `fa-border` class.
```
...
## Pull `Khanda` font awesome icon To the left
To pull `Khanda` icon to the left of the container use `fa-pull-left` class.
```
<div style='width: 200px;'>
<i class='fas fa-khanda fa-pull-left fa-3x'></i>
  ... The text after Khanda Icon will be displayed on the right side of the icon.
</div>
...
## Pull `Khanda` font awesome icon To the left
To pull `Khanda` icon to the right of the container use `fa-pull-right` class.
```
<div style='width: 200px;'>
<i class='fas fa-khanda fa-pull-right fa-3x'></i>
  ... The text after Khanda Icon will be displayed on the left side of the icon.
</div>
<div style = 'clear: both;'></div>
```
...
## Animate `Khanda` font awesome icon
To animate `Khanda` font awesome icon, use `fa-spin` class.
```
...
## Animate `Khanda` font awesome icon with steps
While animating the font awesome icon,We can rotate `Khanda` icon in 8 steps instead of uniform rotation.

We can use `fa-pulse` icon along with `fa-spin` class.
```
<i class='fas fa-khanda fa-spin fa-pulse fa-3x'></i>
```
...
## Rotate `Khanda` font awesome icon
 To rotate `Khanda` font awesome icon, Use `fa-rotate-x` class
...
## Flip `Khanda` font awesome icon
 To flip `Khanda` font awesome icon horizontally and vertically use `fa-flip-horizontal` and `fa-flip-vertical` classes.
...
## Combine `Khanda` font awesome icon with other font awesome icons
...
In the below example, I am displaying `Khanda` font awesome icon on top of icons like `fa-square`,`fa-circle` and `fa-ban`.
