...
next = 'fa-house-chimney-crack'
linktitle = 'fa-hourglass_1'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'true'
...
And we need to add corresponding font awesome icon style for the `Hourglass` icon.
 ...
 `Hourglass` font awesome icon has 2 icon styles.
...
To increase `Hourglass` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f254.
