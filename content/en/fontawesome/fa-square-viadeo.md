...
Use the following icon SVG to display `Square-Viadeo` font awesome icon.
```
...
## Change `Square-Viadeo` font awesome icon size
To increase `Square-Viadeo` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f2aa.
Increase in icon size will be relative to their parent container.
```
<i class='fab fa-square-viadeo fa-lg'>fa-lg</i><br/>
<i class='fab fa-square-viadeo fa-2x'>fa-2x</i><br/>
<i class='fab fa-square-viadeo fa-3x'>fa-3x</i><br/>
<i class='fab fa-square-viadeo fa-4x'>fa-4x</i><br/>
<i class='fab fa-square-viadeo fa-5x'>fa-5x</i><br/>
...
## `Square-Viadeo` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Square-Viadeo` icon and `home` icon may not have same height and width.
...
## Flip `Square-Viadeo` font awesome icon
