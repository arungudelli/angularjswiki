...
Use the following icon SVG to display `Square-Whatsapp` font awesome icon.
```
...
## Change `Square-Whatsapp` font awesome icon size
To increase `Square-Whatsapp` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f40c.
Increase in icon size will be relative to their parent container.
```
<i class='fab fa-square-whatsapp fa-lg'>fa-lg</i><br/>
<i class='fab fa-square-whatsapp fa-2x'>fa-2x</i><br/>
<i class='fab fa-square-whatsapp fa-3x'>fa-3x</i><br/>
<i class='fab fa-square-whatsapp fa-4x'>fa-4x</i><br/>
<i class='fab fa-square-whatsapp fa-5x'>fa-5x</i><br/>
...
## `Square-Whatsapp` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Square-Whatsapp` icon and `home` icon may not have same height and width.
