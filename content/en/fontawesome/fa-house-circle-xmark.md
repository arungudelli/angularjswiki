...
next = 'fa-house-crack'
linktitle = 'fa-house-circle-xmark'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `House-Circle-Xmark` font awesome icon.
```
...
## Change `House-Circle-Xmark` font awesome icon size
