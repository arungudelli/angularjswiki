...
linktitle = 'fa-arrows-down-to-line'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrows-Down-To-Line` font awesome icon.
```
...
## Change `Arrows-Down-To-Line` font awesome icon size
