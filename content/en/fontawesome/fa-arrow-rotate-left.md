...
linktitle = 'fa-arrow-rotate-left'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrow-Rotate-Left` font awesome icon.
```
...
## Change `Arrow-Rotate-Left` font awesome icon size
