...
linktitle = 'fa-plane-circle-exclamation'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Plane-Circle-Exclamation` font awesome icon SVG 
...
## Change `Plane-Circle-Exclamation` font awesome icon size
To increase `Plane-Circle-Exclamation` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e556.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-plane-circle-exclamation fa-lg'>fa-lg</i><br/>
<i class='fas fa-plane-circle-exclamation fa-2x'>fa-2x</i><br/>
<i class='fas fa-plane-circle-exclamation fa-3x'>fa-3x</i><br/>
<i class='fas fa-plane-circle-exclamation fa-4x'>fa-4x</i><br/>
<i class='fas fa-plane-circle-exclamation fa-5x'>fa-5x</i><br/>
...
## `Plane-Circle-Exclamation` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Plane-Circle-Exclamation` icon and `home` icon may not have same height and width.

So to display two icons with fixed width and height we can use `fa-fw` class.
```
<i style='border:1px solid;' class='fas fa-plane-circle-exclamation fa-fw fa-3x'></i>Fixed Width<i style='border:1px solid;' class='fas fa-plane-circle-exclamation fa-3x'></i>Normal<br/>
...
## Animate `Plane-Circle-Exclamation` font awesome icon
...
## Flip `Plane-Circle-Exclamation` font awesome icon
