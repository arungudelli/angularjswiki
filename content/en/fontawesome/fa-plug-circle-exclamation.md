...
linktitle = 'fa-plug-circle-exclamation'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Plug-Circle-Exclamation` font awesome icon SVG 
...
## Change `Plug-Circle-Exclamation` font awesome icon size
To increase `Plug-Circle-Exclamation` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e55d.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-plug-circle-exclamation fa-lg'>fa-lg</i><br/>
<i class='fas fa-plug-circle-exclamation fa-2x'>fa-2x</i><br/>
<i class='fas fa-plug-circle-exclamation fa-3x'>fa-3x</i><br/>
<i class='fas fa-plug-circle-exclamation fa-4x'>fa-4x</i><br/>
<i class='fas fa-plug-circle-exclamation fa-5x'>fa-5x</i><br/>
...
## `Plug-Circle-Exclamation` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Plug-Circle-Exclamation` icon and `home` icon may not have same height and width.
