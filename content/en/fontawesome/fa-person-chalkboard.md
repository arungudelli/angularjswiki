...
linktitle = 'fa-person-chalkboard'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Person-Chalkboard` font awesome icon.
```
...
## Change `Person-Chalkboard` font awesome icon size
