...
linktitle = 'fa-arrow-up-short-wide'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrow-Up-Short-Wide` font awesome icon.
```
...
## Change `Arrow-Up-Short-Wide` font awesome icon size
