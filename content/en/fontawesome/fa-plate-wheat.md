...
## Change `Plate-Wheat` font awesome icon size
To increase `Plate-Wheat` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e55a.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-plate-wheat fa-lg'>fa-lg</i><br/>
...
## `Plate-Wheat` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Plate-Wheat` icon and `home` icon may not have same height and width.
