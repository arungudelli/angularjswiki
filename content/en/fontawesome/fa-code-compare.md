...
Use the following icon SVG to display `Code-Compare` font awesome icon.
```
...
## Change `Code-Compare` font awesome icon size
To increase `Code-Compare` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e13a.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-code-compare fa-lg'>fa-lg</i><br/>
<i class='fas fa-code-compare fa-2x'>fa-2x</i><br/>
<i class='fas fa-code-compare fa-3x'>fa-3x</i><br/>
<i class='fas fa-code-compare fa-4x'>fa-4x</i><br/>
<i class='fas fa-code-compare fa-5x'>fa-5x</i><br/>
...
## `Code-Compare` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Code-Compare` icon and `home` icon may not have same height and width.
...
## Flip `Code-Compare` font awesome icon
