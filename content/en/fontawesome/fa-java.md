...
`Java` icon has 1 icon style i.e.,brands. 
...
```
<li><span class='Java fontawesomeicon'></span>Java</li>
```
...
To increase `Java` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f4e4.
...
```
<i style='border:1px solid;' class='fab fa-java fa-fw fa-3x'></i>Fixed Width<i style='border:1px solid;' class='fab fa-java fa-3x'></i>Normal<br/>
...
```
<i class='fab fa-java fa-spin fa-pulse fa-3x'></i>
```
