+++
title="fa-prescription-bottle-alt icon in font awesome icons"
summary="fa-prescription-bottle-alt icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-prescription-bottle-alt,f486,fa-prescription-bottle-alt"]
...
fa-prescription-bottle-alt icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-prescription-bottle-alt</td><td>fa-prescription-bottle-alt</td><td>f486</td></tr></tbody></table></div>


{{% toc %}}


## fa-prescription-bottle-alt icon Usage

To display fa-prescription-bottle-alt icon add predefined class name i.e.,fa-prescription-bottle-alt (with prefix fa-) to the 'i' tag.
...
## Change fa-prescription-bottle-alt icon size
To increase fa-prescription-bottle-alt font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-prescription-bottle-alt.
...
## fa-prescription-bottle-alt Icon with Fixed Width 
...
## fa-prescription-bottle-alt Icon Border 
...
## Pull fa-prescription-bottle-alt icon To the left
...
## Pull fa-prescription-bottle-alt icon To the right
...
## Animate fa-prescription-bottle-alt icon using fa-spin
...
## Animate fa-prescription-bottle-alt icon with steps
...
## Rotate fa-prescription-bottle-alt Icon using fa-rotate-x
...
## Flip fa-prescription-bottle-alt Icon using fa-flip-*
...
## Combine fa-prescription-bottle-alt icon with other font awesome icons
