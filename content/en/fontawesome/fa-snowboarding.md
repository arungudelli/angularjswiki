+++
title="Snowboarding icon in font awesome icons"
summary="Snowboarding icon represented as fa-snowboarding in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-snowboarding,f7ce,Snowboarding"]
...
Snowboarding icon represented as fa-snowboarding in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>Snowboarding</td><td>fa-snowboarding</td><td>f7ce</td></tr></tbody></table></div>



## Snowboarding icon Usage

To display Snowboarding icon add predefined class name i.e.,fa-snowboarding (with prefix fa-) to the 'i' tag.
...
## Change Snowboarding icon size
To increase Snowboarding font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-snowboarding.
...
## Snowboarding Icon with Fixed Width 
...
## Pull Snowboarding icon To the left
...
## Pull Snowboarding icon To the right
...
## Animate Snowboarding icon using fa-spin
...
## Animate Snowboarding icon with steps
...
## Rotate Snowboarding Icon using fa-rotate-x
...
## Flip Snowboarding Icon using fa-flip-*
...
## Combine Snowboarding icon with other font awesome icons
