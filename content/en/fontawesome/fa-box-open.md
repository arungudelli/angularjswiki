+++
title="fa-box-open icon in font awesome icons"
summary="fa-box-open icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-box-open,f49e,fa-box-open"]
...
fa-box-open icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-box-open</td><td>fa-box-open</td><td>f49e</td></tr></tbody></table></div>


{{% toc %}}


## fa-box-open icon Usage

To display fa-box-open icon add predefined class name i.e.,fa-box-open (with prefix fa-) to the 'i' tag.
...
## Change fa-box-open icon size
To increase fa-box-open font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-box-open.
...
## fa-box-open Icon with Fixed Width 
...
## Pull fa-box-open icon To the left
...
## Pull fa-box-open icon To the right
...
## Animate fa-box-open icon using fa-spin
...
## Animate fa-box-open icon with steps
...
## Rotate fa-box-open Icon using fa-rotate-x
...
## Flip fa-box-open Icon using fa-flip-*
...
## Combine fa-box-open icon with other font awesome icons
