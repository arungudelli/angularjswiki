...
prev = 'fa-heading'
next = 'fa-headphones'
linktitle = 'fa-headphones-simple'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Headphones-Simple` font awesome icon.
```
...
## Change `Headphones-Simple` font awesome icon size
