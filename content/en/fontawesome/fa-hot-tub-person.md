...
Use the following icon SVG to display `Hot-Tub-Person` font awesome icon.
```
...
## Change `Hot-Tub-Person` font awesome icon size
To increase `Hot-Tub-Person` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f593.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-hot-tub-person fa-lg'>fa-lg</i><br/>
<i class='fas fa-hot-tub-person fa-2x'>fa-2x</i><br/>
<i class='fas fa-hot-tub-person fa-3x'>fa-3x</i><br/>
<i class='fas fa-hot-tub-person fa-4x'>fa-4x</i><br/>
<i class='fas fa-hot-tub-person fa-5x'>fa-5x</i><br/>
...
## `Hot-Tub-Person` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Hot-Tub-Person` icon and `home` icon may not have same height and width.
