+++
title="fa-arrow-alt-circle-down icon in font awesome icons"
summary="fa-arrow-alt-circle-down icon in font awesome icons has 2 variants regular (far) and solid (fas)"
keywords=["fa-arrow-alt-circle-down,f358,fa-arrow-alt-circle-down"]
...
fa-arrow-alt-circle-down icon in font awesome icons has 2 variants regular (far) and solid (fas)

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-arrow-alt-circle-down</td><td>fa-arrow-alt-circle-down</td><td>f358</td></tr></tbody></table></div>


{{% toc %}}


## fa-arrow-alt-circle-down icon Usage

To display fa-arrow-alt-circle-down icon add predefined class name i.e.,fa-arrow-alt-circle-down (with prefix fa-) to the 'i' tag.
...
## Change fa-arrow-alt-circle-down icon size
To increase fa-arrow-alt-circle-down font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-arrow-alt-circle-down.
...
## fa-arrow-alt-circle-down Icon with Fixed Width 
...
## fa-arrow-alt-circle-down Icon Border 
...
## Pull fa-arrow-alt-circle-down icon To the left
...
## Pull fa-arrow-alt-circle-down icon To the right
...
## Animate fa-arrow-alt-circle-down icon using fa-spin
...
## Animate fa-arrow-alt-circle-down icon with steps
...
## Rotate fa-arrow-alt-circle-down Icon using fa-rotate-x
...
## Flip fa-arrow-alt-circle-down Icon using fa-flip-*
...
## Combine fa-arrow-alt-circle-down icon with other font awesome icons
