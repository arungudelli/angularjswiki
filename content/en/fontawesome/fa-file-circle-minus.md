...
linktitle = 'fa-file-circle-minus'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `File-Circle-Minus` font awesome icon.
```
...
## Change `File-Circle-Minus` font awesome icon size
