+++
title="fa-shopping-basket icon in font awesome icons"
summary="fa-shopping-basket icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-shopping-basket,f291,fa-shopping-basket"]
...
fa-shopping-basket icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-shopping-basket</td><td>fa-shopping-basket</td><td>f291</td></tr></tbody></table></div>


{{% toc %}}


## fa-shopping-basket icon Usage

To display fa-shopping-basket icon add predefined class name i.e.,fa-shopping-basket (with prefix fa-) to the 'i' tag.
...
## Change fa-shopping-basket icon size
To increase fa-shopping-basket font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-shopping-basket.
...
## fa-shopping-basket Icon with Fixed Width 
...
## fa-shopping-basket Icon Border 
...
## Pull fa-shopping-basket icon To the left
...
## Pull fa-shopping-basket icon To the right
...
## Animate fa-shopping-basket icon using fa-spin
...
## Animate fa-shopping-basket icon with steps
...
## Rotate fa-shopping-basket Icon using fa-rotate-x
...
## Flip fa-shopping-basket Icon using fa-flip-*
...
## Combine fa-shopping-basket icon with other font awesome icons
