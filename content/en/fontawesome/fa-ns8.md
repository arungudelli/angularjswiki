+++
title="fa-ns8 icon in font awesome icons"
summary="fa-ns8 icon in font awesome icons is part of brand (fab) icons"
keywords=["fa-ns8,f3d5,fa-ns8"]
...
fa-ns8 icon in font awesome icons is part of brand (fab) icons

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-ns8</td><td>fa-ns8</td><td>f3d5</td></tr></tbody></table></div>
...
To display fa-ns8 icon add predefined class name i.e.,fa-ns8 (with prefix fa-) to the 'i' tag.
...
## Change fa-ns8 icon size
To increase fa-ns8 font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-ns8.
...
## Animate fa-ns8 icon using fa-spin
...
## Animate fa-ns8 icon with steps
...
## Rotate fa-ns8 Icon using fa-rotate-x
...
## Flip fa-ns8 Icon using fa-flip-*
...
## Combine fa-ns8 icon with other font awesome icons
