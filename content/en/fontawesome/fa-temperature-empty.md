...
linktitle = 'fa-temperature-empty'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Temperature-Empty` font awesome icon.
```
...
## Change `Temperature-Empty` font awesome icon size
