...
linktitle = 'fa-square-odnoklassniki'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Square-Odnoklassniki` font awesome icon SVG 
...
## Change `Square-Odnoklassniki` font awesome icon size
To increase `Square-Odnoklassniki` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f264.
Increase in icon size will be relative to their parent container.
```
<i class='fab fa-square-odnoklassniki fa-lg'>fa-lg</i><br/>
<i class='fab fa-square-odnoklassniki fa-2x'>fa-2x</i><br/>
<i class='fab fa-square-odnoklassniki fa-3x'>fa-3x</i><br/>
<i class='fab fa-square-odnoklassniki fa-4x'>fa-4x</i><br/>
<i class='fab fa-square-odnoklassniki fa-5x'>fa-5x</i><br/>
...
## `Square-Odnoklassniki` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Square-Odnoklassniki` icon and `home` icon may not have same height and width.
