...
next = 'fa-filter'
linktitle = 'fa-filter-circle-xmark'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Filter-Circle-Xmark` font awesome icon.
```
...
## Change `Filter-Circle-Xmark` font awesome icon size
