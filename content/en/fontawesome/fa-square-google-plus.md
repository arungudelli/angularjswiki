...
linktitle = 'fa-square-google-plus'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Square-Google-Plus` font awesome icon.
```
...
## Change `Square-Google-Plus` font awesome icon size
