+++
title="Person Booth icon in font awesome icons"
summary="Person Booth icon represented as fa-person-booth in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-person-booth,f756,Person Booth"]
...
Person Booth icon represented as fa-person-booth in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>Person Booth</td><td>fa-person-booth</td><td>f756</td></tr></tbody></table></div>



## Person Booth icon Usage

To display Person Booth icon add predefined class name i.e.,fa-person-booth (with prefix fa-) to the 'i' tag.
...
## Change Person Booth icon size
To increase Person Booth font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-person-booth.
...
## Person Booth Icon with Fixed Width 
...
## Pull Person Booth icon To the left
...
## Pull Person Booth icon To the right
...
## Animate Person Booth icon using fa-spin
...
## Animate Person Booth icon with steps
...
## Rotate Person Booth Icon using fa-rotate-x
...
## Flip Person Booth Icon using fa-flip-*
...
## Combine Person Booth icon with other font awesome icons
