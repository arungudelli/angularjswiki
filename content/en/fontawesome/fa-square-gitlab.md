...
Use the following icon SVG to display `Square-Gitlab` font awesome icon.
```
...
## Change `Square-Gitlab` font awesome icon size
To increase `Square-Gitlab` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e5ae.
Increase in icon size will be relative to their parent container.
```
<i class='fab fa-square-gitlab fa-lg'>fa-lg</i><br/>
<i class='fab fa-square-gitlab fa-2x'>fa-2x</i><br/>
<i class='fab fa-square-gitlab fa-3x'>fa-3x</i><br/>
<i class='fab fa-square-gitlab fa-4x'>fa-4x</i><br/>
<i class='fab fa-square-gitlab fa-5x'>fa-5x</i><br/>
...
## `Square-Gitlab` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Square-Gitlab` icon and `home` icon may not have same height and width.
...
## Flip `Square-Gitlab` font awesome icon
