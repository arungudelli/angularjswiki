...
## Change `Basketball` font awesome icon size
To increase `Basketball` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f434.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-basketball fa-lg'>fa-lg</i><br/>
<i class='fas fa-basketball fa-2x'>fa-2x</i><br/>
<i class='fas fa-basketball fa-3x'>fa-3x</i><br/>
<i class='fas fa-basketball fa-4x'>fa-4x</i><br/>
<i class='fas fa-basketball fa-5x'>fa-5x</i><br/>
...
## `Basketball` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Basketball` icon and `home` icon may not have same height and width.
