...
linktitle = 'fa-square-phone-flip'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Square-Phone-Flip` font awesome icon.
```
...
## Change `Square-Phone-Flip` font awesome icon size
