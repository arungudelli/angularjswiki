...
linktitle = 'fa-temperature-quarter'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Temperature-Quarter` font awesome icon.
```
...
## Change `Temperature-Quarter` font awesome icon size
