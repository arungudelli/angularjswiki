...
linktitle = 'fa-person-circle-xmark'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Person-Circle-Xmark` font awesome icon.
```
...
## Change `Person-Circle-Xmark` font awesome icon size
To increase `Person-Circle-Xmark` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e543.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-person-circle-xmark fa-lg'>fa-lg</i><br/>
<i class='fas fa-person-circle-xmark fa-2x'>fa-2x</i><br/>
<i class='fas fa-person-circle-xmark fa-3x'>fa-3x</i><br/>
<i class='fas fa-person-circle-xmark fa-4x'>fa-4x</i><br/>
<i class='fas fa-person-circle-xmark fa-5x'>fa-5x</i><br/>
...
## `Person-Circle-Xmark` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Person-Circle-Xmark` icon and `home` icon may not have same height and width.
...
## Flip `Person-Circle-Xmark` font awesome icon
