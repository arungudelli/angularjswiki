+++
title="fa-wrench icon in font awesome icons"
summary="fa-wrench icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-wrench,f0ad,fa-wrench"]
...
fa-wrench icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-wrench</td><td>fa-wrench</td><td>f0ad</td></tr></tbody></table></div>


{{% toc %}}


## fa-wrench icon Usage

To display fa-wrench icon add predefined class name i.e.,fa-wrench (with prefix fa-) to the 'i' tag.
...
## Change fa-wrench icon size
To increase fa-wrench font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-wrench.
...
## fa-wrench Icon with Fixed Width 
...
## Pull fa-wrench icon To the left
...
## Pull fa-wrench icon To the right
...
## Animate fa-wrench icon using fa-spin
...
## Animate fa-wrench icon with steps
...
## Rotate fa-wrench Icon using fa-rotate-x
...
## Flip fa-wrench Icon using fa-flip-*
...
## Combine fa-wrench icon with other font awesome icons
