+++
title="fa-laptop-house icon in font awesome icons"
summary="fa-laptop-house icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-laptop-house,f966,fa-laptop-house"]
...
fa-laptop-house icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-laptop-house</td><td>fa-laptop-house</td><td>f966</td></tr></tbody></table></div>


{{% toc %}}


## fa-laptop-house icon Usage

To display fa-laptop-house icon add predefined class name i.e.,fa-laptop-house (with prefix fa-) to the 'i' tag.
...
## Change fa-laptop-house icon size
To increase fa-laptop-house font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-laptop-house.
...
## fa-laptop-house Icon with Fixed Width 
...
## Pull fa-laptop-house icon To the left
...
## Pull fa-laptop-house icon To the right
...
## Animate fa-laptop-house icon using fa-spin
...
## Animate fa-laptop-house icon with steps
...
## Rotate fa-laptop-house Icon using fa-rotate-x
...
## Flip fa-laptop-house Icon using fa-flip-*
...
## Combine fa-laptop-house icon with other font awesome icons
