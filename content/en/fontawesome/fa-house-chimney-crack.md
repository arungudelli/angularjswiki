...
linktitle = 'fa-house-chimney-crack'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `House-Chimney-Crack` font awesome icon.
```
...
## Change `House-Chimney-Crack` font awesome icon size
