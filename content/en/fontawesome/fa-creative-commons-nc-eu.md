+++
title="fa-creative-commons-nc-eu icon in font awesome icons"
summary="fa-creative-commons-nc-eu icon in font awesome icons is part of brand (fab) icons"
keywords=["fa-creative-commons-nc-eu,f4e9,fa-creative-commons-nc-eu"]
...
fa-creative-commons-nc-eu icon in font awesome icons is part of brand (fab) icons

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-creative-commons-nc-eu</td><td>fa-creative-commons-nc-eu</td><td>f4e9</td></tr></tbody></table></div>


{{% toc %}}


## fa-creative-commons-nc-eu icon Usage

To display fa-creative-commons-nc-eu icon add predefined class name i.e.,fa-creative-commons-nc-eu (with prefix fa-) to the 'i' tag.
...
## Change fa-creative-commons-nc-eu icon size
To increase fa-creative-commons-nc-eu font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-creative-commons-nc-eu.
...
## fa-creative-commons-nc-eu Icon with Fixed Width 
...
## fa-creative-commons-nc-eu Icon Border 
...
## Pull fa-creative-commons-nc-eu icon To the left
...
## Pull fa-creative-commons-nc-eu icon To the right
...
## Animate fa-creative-commons-nc-eu icon using fa-spin
...
## Animate fa-creative-commons-nc-eu icon with steps
...
## Rotate fa-creative-commons-nc-eu Icon using fa-rotate-x
...
## Flip fa-creative-commons-nc-eu Icon using fa-flip-*
...
## Combine fa-creative-commons-nc-eu icon with other font awesome icons
