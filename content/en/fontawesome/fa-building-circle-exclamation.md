...
linktitle = 'fa-building-circle-exclamation'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Building-Circle-Exclamation` font awesome icon SVG 
...
For example `Building-Circle-Exclamation` icon and `home` icon may not have same height and width.
