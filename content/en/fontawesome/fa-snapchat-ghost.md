+++
title="fa-snapchat-ghost icon in font awesome icons"
summary="fa-snapchat-ghost icon in font awesome icons is part of brand (fab) icons"
keywords=["fa-snapchat-ghost,f2ac,fa-snapchat-ghost"]
...
fa-snapchat-ghost icon in font awesome icons is part of brand (fab) icons

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-snapchat-ghost</td><td>fa-snapchat-ghost</td><td>f2ac</td></tr></tbody></table></div>


{{% toc %}}


## fa-snapchat-ghost icon Usage

To display fa-snapchat-ghost icon add predefined class name i.e.,fa-snapchat-ghost (with prefix fa-) to the 'i' tag.
...
## Change fa-snapchat-ghost icon size
To increase fa-snapchat-ghost font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-snapchat-ghost.
...
## fa-snapchat-ghost Icon with Fixed Width 
...
## Pull fa-snapchat-ghost icon To the left
...
## Pull fa-snapchat-ghost icon To the right
...
## Animate fa-snapchat-ghost icon using fa-spin
...
## Animate fa-snapchat-ghost icon with steps
...
## Rotate fa-snapchat-ghost Icon using fa-rotate-x
...
## Flip fa-snapchat-ghost Icon using fa-flip-*
...
## Combine fa-snapchat-ghost icon with other font awesome icons
