+++
title="fa-evernote icon in font awesome icons"
summary="fa-evernote icon in font awesome icons is part of brand (fab) icons"
keywords=["fa-evernote,f839,fa-evernote"]
...
fa-evernote icon in font awesome icons is part of brand (fab) icons

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-evernote</td><td>fa-evernote</td><td>f839</td></tr></tbody></table></div>


{{% toc %}}


## fa-evernote icon Usage

To display fa-evernote icon add predefined class name i.e.,fa-evernote (with prefix fa-) to the 'i' tag.
...
## Change fa-evernote icon size
To increase fa-evernote font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-evernote.
...
## fa-evernote Icon with Fixed Width 
...
## Pull fa-evernote icon To the left
...
## Pull fa-evernote icon To the right
...
## Animate fa-evernote icon using fa-spin
...
## Animate fa-evernote icon with steps
...
## Rotate fa-evernote Icon using fa-rotate-x
...
## Flip fa-evernote Icon using fa-flip-*
...
## Combine fa-evernote icon with other font awesome icons
