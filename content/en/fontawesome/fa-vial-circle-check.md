...
prev = 'fa-vest'
next = 'fa-vial-virus'
linktitle = 'fa-vial-circle-check'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Vial-Circle-Check` font awesome icon.
```
...
## Change `Vial-Circle-Check` font awesome icon size
