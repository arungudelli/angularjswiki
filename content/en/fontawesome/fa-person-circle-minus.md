...
linktitle = 'fa-person-circle-minus'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Person-Circle-Minus` font awesome icon.
```
...
## Change `Person-Circle-Minus` font awesome icon size
