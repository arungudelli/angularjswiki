...
next = 'fa-heart-crack'
linktitle = 'fa-heart-circle-xmark'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Heart-Circle-Xmark` font awesome icon.
```
...
## Change `Heart-Circle-Xmark` font awesome icon size
