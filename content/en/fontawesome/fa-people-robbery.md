...
Use the following icon SVG to display `People-Robbery` font awesome icon.
```
...
## Change `People-Robbery` font awesome icon size
To increase `People-Robbery` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e536.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-people-robbery fa-lg'>fa-lg</i><br/>
<i class='fas fa-people-robbery fa-2x'>fa-2x</i><br/>
<i class='fas fa-people-robbery fa-3x'>fa-3x</i><br/>
<i class='fas fa-people-robbery fa-4x'>fa-4x</i><br/>
<i class='fas fa-people-robbery fa-5x'>fa-5x</i><br/>
...
## `People-Robbery` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `People-Robbery` icon and `home` icon may not have same height and width.
...
## Flip `People-Robbery` font awesome icon
