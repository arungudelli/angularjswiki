...
linktitle = 'fa-square-share-nodes'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Square-Share-Nodes` font awesome icon.
```
...
## Change `Square-Share-Nodes` font awesome icon size
