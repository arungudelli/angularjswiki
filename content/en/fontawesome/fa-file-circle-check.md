...
linktitle = 'fa-file-circle-check'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `File-Circle-Check` font awesome icon.
```
...
## Change `File-Circle-Check` font awesome icon size
