+++
title="fa-sort-numeric-down-alt icon in font awesome icons"
summary="fa-sort-numeric-down-alt icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-sort-numeric-down-alt,f886,fa-sort-numeric-down-alt"]
...
fa-sort-numeric-down-alt icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-sort-numeric-down-alt</td><td>fa-sort-numeric-down-alt</td><td>f886</td></tr></tbody></table></div>


{{% toc %}}


## fa-sort-numeric-down-alt icon Usage

To display fa-sort-numeric-down-alt icon add predefined class name i.e.,fa-sort-numeric-down-alt (with prefix fa-) to the 'i' tag.
...
## Change fa-sort-numeric-down-alt icon size
To increase fa-sort-numeric-down-alt font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-sort-numeric-down-alt.
...
## fa-sort-numeric-down-alt Icon with Fixed Width 
...
## fa-sort-numeric-down-alt Icon Border 
...
## Pull fa-sort-numeric-down-alt icon To the left
...
## Pull fa-sort-numeric-down-alt icon To the right
...
## Animate fa-sort-numeric-down-alt icon using fa-spin
...
## Animate fa-sort-numeric-down-alt icon with steps
...
## Rotate fa-sort-numeric-down-alt Icon using fa-rotate-x
...
## Flip fa-sort-numeric-down-alt Icon using fa-flip-*
...
## Combine fa-sort-numeric-down-alt icon with other font awesome icons
