...
Use the following icon SVG to display `Plug-Circle-Xmark` font awesome icon.
```
...
## Change `Plug-Circle-Xmark` font awesome icon size
To increase `Plug-Circle-Xmark` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e560.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-plug-circle-xmark fa-lg'>fa-lg</i><br/>
<i class='fas fa-plug-circle-xmark fa-2x'>fa-2x</i><br/>
<i class='fas fa-plug-circle-xmark fa-3x'>fa-3x</i><br/>
<i class='fas fa-plug-circle-xmark fa-4x'>fa-4x</i><br/>
<i class='fas fa-plug-circle-xmark fa-5x'>fa-5x</i><br/>
...
## `Plug-Circle-Xmark` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Plug-Circle-Xmark` icon and `home` icon may not have same height and width.
...
## Flip `Plug-Circle-Xmark` font awesome icon
