...
Use the following icon SVG to display `Bottle-Water` font awesome icon.
```
...
## Change `Bottle-Water` font awesome icon size
To increase `Bottle-Water` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e4c5.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-bottle-water fa-lg'>fa-lg</i><br/>
<i class='fas fa-bottle-water fa-2x'>fa-2x</i><br/>
<i class='fas fa-bottle-water fa-3x'>fa-3x</i><br/>
<i class='fas fa-bottle-water fa-4x'>fa-4x</i><br/>
<i class='fas fa-bottle-water fa-5x'>fa-5x</i><br/>
...
## `Bottle-Water` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Bottle-Water` icon and `home` icon may not have same height and width.
...
## Flip `Bottle-Water` font awesome icon
