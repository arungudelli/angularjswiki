...
`Waze` font awesome icon is part of brands icons. 



{{%toc%}}
## `Waze` font awesome icon usage
We can display `Waze` font awesome icon using 3 different ways depending upon our requirement.
...
## `Waze` font awesome icon CSS class name

To display `Waze` font awesome icon, add predefined class name i.e.,`fa-waze` (with prefix `fa-`) to the `i` tag. 

And we need to add corresponding font awesome icon style for the `Waze` icon.


`Waze` icon has 1 icon style i.e.,brands. 
...
## `Waze` font awesome icon CSS Content Code 

We can display `Waze` font awesome icon using it's CSS Content Code ` \f83f` 
...
## `Waze` font awesome icon SVG 

Use the following icon SVG to display `Waze` font awesome icon.
```
...
## Change `Waze` font awesome icon size
To increase `Waze` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f83f.
...
## `Waze` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Waze` icon and `home` icon may not have same height and width.
...
## `Waze` font awesome icon Border
To add border to `Waze` font awesome icon, use `fa-border` class.
```
...
## Pull `Waze` font awesome icon To the left
To pull `Waze` icon to the left of the container use `fa-pull-left` class.
```
...
## Pull `Waze` font awesome icon To the left
To pull `Waze` icon to the right of the container use `fa-pull-right` class.
```
<div style='width: 200px;'>
...
## Animate `Waze` font awesome icon
To animate `Waze` font awesome icon, use `fa-spin` class.
```
...
## Animate `Waze` font awesome icon with steps
While animating the font awesome icon,We can rotate `Waze` icon in 8 steps instead of uniform rotation.
...
## Rotate `Waze` font awesome icon
 To rotate `Waze` font awesome icon, Use `fa-rotate-x` class
...
## Flip `Waze` font awesome icon
 To flip `Waze` font awesome icon horizontally and vertically use `fa-flip-horizontal` and `fa-flip-vertical` classes.
...
## Combine `Waze` font awesome icon with other font awesome icons
...
In the below example, I am displaying `Waze` font awesome icon on top of icons like `fa-square`,`fa-circle` and `fa-ban`.
