...
`Cc-Visa` icon has 1 icon style i.e.,brands. 
...
To increase `Cc-Visa` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f1f0.
