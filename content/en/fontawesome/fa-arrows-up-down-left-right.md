...
linktitle = 'fa-arrows-up-down-left-right'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Arrows-Up-Down-Left-Right` font awesome icon SVG 
...
## Change `Arrows-Up-Down-Left-Right` font awesome icon size
To increase `Arrows-Up-Down-Left-Right` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f047.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-arrows-up-down-left-right fa-lg'>fa-lg</i><br/>
<i class='fas fa-arrows-up-down-left-right fa-2x'>fa-2x</i><br/>
<i class='fas fa-arrows-up-down-left-right fa-3x'>fa-3x</i><br/>
<i class='fas fa-arrows-up-down-left-right fa-4x'>fa-4x</i><br/>
<i class='fas fa-arrows-up-down-left-right fa-5x'>fa-5x</i><br/>
...
## `Arrows-Up-Down-Left-Right` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Arrows-Up-Down-Left-Right` icon and `home` icon may not have same height and width.
