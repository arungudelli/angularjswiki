...
Use the following icon SVG to display `Square-Steam` font awesome icon.
```
...
## Change `Square-Steam` font awesome icon size
To increase `Square-Steam` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f1b7.
Increase in icon size will be relative to their parent container.
```
<i class='fab fa-square-steam fa-lg'>fa-lg</i><br/>
<i class='fab fa-square-steam fa-2x'>fa-2x</i><br/>
<i class='fab fa-square-steam fa-3x'>fa-3x</i><br/>
<i class='fab fa-square-steam fa-4x'>fa-4x</i><br/>
<i class='fab fa-square-steam fa-5x'>fa-5x</i><br/>
...
## `Square-Steam` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Square-Steam` icon and `home` icon may not have same height and width.
...
## Flip `Square-Steam` font awesome icon
