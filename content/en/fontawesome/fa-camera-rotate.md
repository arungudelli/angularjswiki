...
Use the following icon SVG to display `Camera-Rotate` font awesome icon.
```
...
## Change `Camera-Rotate` font awesome icon size
To increase `Camera-Rotate` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e0d8.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-camera-rotate fa-lg'>fa-lg</i><br/>
<i class='fas fa-camera-rotate fa-2x'>fa-2x</i><br/>
<i class='fas fa-camera-rotate fa-3x'>fa-3x</i><br/>
<i class='fas fa-camera-rotate fa-4x'>fa-4x</i><br/>
<i class='fas fa-camera-rotate fa-5x'>fa-5x</i><br/>
...
## `Camera-Rotate` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Camera-Rotate` icon and `home` icon may not have same height and width.
...
## Flip `Camera-Rotate` font awesome icon
