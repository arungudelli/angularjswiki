...
Use the following icon SVG to display `Person-Skiing` font awesome icon.
```
...
## Change `Person-Skiing` font awesome icon size
To increase `Person-Skiing` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f7c9.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-person-skiing fa-lg'>fa-lg</i><br/>
<i class='fas fa-person-skiing fa-2x'>fa-2x</i><br/>
<i class='fas fa-person-skiing fa-3x'>fa-3x</i><br/>
<i class='fas fa-person-skiing fa-4x'>fa-4x</i><br/>
<i class='fas fa-person-skiing fa-5x'>fa-5x</i><br/>
...
## `Person-Skiing` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Person-Skiing` icon and `home` icon may not have same height and width.
...
## Flip `Person-Skiing` font awesome icon
