...
## Change `Wheat-Awn` font awesome icon size
To increase `Wheat-Awn` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e2cd.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-wheat-awn fa-lg'>fa-lg</i><br/>
...
## `Wheat-Awn` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Wheat-Awn` icon and `home` icon may not have same height and width.
