...
linktitle = 'fa-arrow-up-from-water-pump'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Arrow-Up-From-Water-Pump` font awesome icon SVG 
...
For example `Arrow-Up-From-Water-Pump` icon and `home` icon may not have same height and width.
