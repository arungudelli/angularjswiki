...
next = 'fa-asterisk'
linktitle = 'fa-arrows-up-to-line'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrows-Up-To-Line` font awesome icon.
```
...
## Change `Arrows-Up-To-Line` font awesome icon size
