...
linktitle = 'fa-file-circle-question'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `File-Circle-Question` font awesome icon SVG 
...
## Change `File-Circle-Question` font awesome icon size
To increase `File-Circle-Question` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e4ef.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-file-circle-question fa-lg'>fa-lg</i><br/>
<i class='fas fa-file-circle-question fa-2x'>fa-2x</i><br/>
<i class='fas fa-file-circle-question fa-3x'>fa-3x</i><br/>
<i class='fas fa-file-circle-question fa-4x'>fa-4x</i><br/>
<i class='fas fa-file-circle-question fa-5x'>fa-5x</i><br/>
...
## `File-Circle-Question` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `File-Circle-Question` icon and `home` icon may not have same height and width.
