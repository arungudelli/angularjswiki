...
Use the following icon SVG to display `Person-Harassing` font awesome icon.
```
...
## Change `Person-Harassing` font awesome icon size
To increase `Person-Harassing` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \e549.
...
## `Person-Harassing` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Person-Harassing` icon and `home` icon may not have same height and width.
...
## Flip `Person-Harassing` font awesome icon
