...
linktitle = 'fa-person-military-to-person'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
## `Person-Military-To-Person` font awesome icon SVG 
...
For example `Person-Military-To-Person` icon and `home` icon may not have same height and width.
