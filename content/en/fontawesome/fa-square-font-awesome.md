...
next = 'fa-square-git'
linktitle = 'fa-square-font-awesome'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Square-Font-Awesome` font awesome icon.
```
...
## Change `Square-Font-Awesome` font awesome icon size
