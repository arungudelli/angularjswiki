...
Use the following icon SVG to display `Arrow-Up-Z-A` font awesome icon.
```
...
## Change `Arrow-Up-Z-A` font awesome icon size
To increase `Arrow-Up-Z-A` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f882.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-arrow-up-z-a fa-lg'>fa-lg</i><br/>
<i class='fas fa-arrow-up-z-a fa-2x'>fa-2x</i><br/>
<i class='fas fa-arrow-up-z-a fa-3x'>fa-3x</i><br/>
<i class='fas fa-arrow-up-z-a fa-4x'>fa-4x</i><br/>
<i class='fas fa-arrow-up-z-a fa-5x'>fa-5x</i><br/>
...
## `Arrow-Up-Z-A` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Arrow-Up-Z-A` icon and `home` icon may not have same height and width.
...
## Flip `Arrow-Up-Z-A` font awesome icon
