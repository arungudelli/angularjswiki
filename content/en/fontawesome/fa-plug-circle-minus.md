...
linktitle = 'fa-plug-circle-minus'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Plug-Circle-Minus` font awesome icon.
```
...
## Change `Plug-Circle-Minus` font awesome icon size
