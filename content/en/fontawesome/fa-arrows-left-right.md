...
linktitle = 'fa-arrows-left-right'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrows-Left-Right` font awesome icon.
```
...
## Change `Arrows-Left-Right` font awesome icon size
