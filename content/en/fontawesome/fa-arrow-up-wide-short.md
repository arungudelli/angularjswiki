...
linktitle = 'fa-arrow-up-wide-short'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Arrow-Up-Wide-Short` font awesome icon.
```
...
## Change `Arrow-Up-Wide-Short` font awesome icon size
