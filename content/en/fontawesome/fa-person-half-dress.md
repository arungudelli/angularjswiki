...
linktitle = 'fa-person-half-dress'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Person-Half-Dress` font awesome icon.
```
...
## Change `Person-Half-Dress` font awesome icon size
