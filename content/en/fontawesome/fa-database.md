...
`Database` icon has 1 icon style i.e.,solid. 
...
To increase `Database` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f1c0.
