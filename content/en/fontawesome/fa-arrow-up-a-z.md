...
Use the following icon SVG to display `Arrow-Up-A-Z` font awesome icon.
```
...
## Change `Arrow-Up-A-Z` font awesome icon size
To increase `Arrow-Up-A-Z` font awesome icon size, use the `fa-lg(33 % increase)`, `fa-2x`, `fa-3x`, `fa-4x`, or `fa-5x` classes along with icon class  \f15e.
Increase in icon size will be relative to their parent container.
```
<i class='fas fa-arrow-up-a-z fa-lg'>fa-lg</i><br/>
<i class='fas fa-arrow-up-a-z fa-2x'>fa-2x</i><br/>
<i class='fas fa-arrow-up-a-z fa-3x'>fa-3x</i><br/>
<i class='fas fa-arrow-up-a-z fa-4x'>fa-4x</i><br/>
<i class='fas fa-arrow-up-a-z fa-5x'>fa-5x</i><br/>
...
## `Arrow-Up-A-Z` font awesome icon with Fixed Width
All the font awesome icons does not have same width.

For example `Arrow-Up-A-Z` icon and `home` icon may not have same height and width.

So to display two icons with fixed width and height we can use `fa-fw` class.
```
<i style='border:1px solid;' class='fas fa-arrow-up-a-z fa-fw fa-3x'></i>Fixed Width<i style='border:1px solid;' class='fas fa-arrow-up-a-z fa-3x'></i>Normal<br/>
...
## Animate `Arrow-Up-A-Z` font awesome icon
