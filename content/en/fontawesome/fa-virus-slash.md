+++
title="fa-virus-slash icon in font awesome icons"
summary="fa-virus-slash icon in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-virus-slash,f975,fa-virus-slash"]
...
fa-virus-slash icon in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>fa-virus-slash</td><td>fa-virus-slash</td><td>f975</td></tr></tbody></table></div>


{{% toc %}}


## fa-virus-slash icon Usage

To display fa-virus-slash icon add predefined class name i.e.,fa-virus-slash (with prefix fa-) to the 'i' tag.
...
## Change fa-virus-slash icon size
To increase fa-virus-slash font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-virus-slash.
...
## fa-virus-slash Icon with Fixed Width 
...
## Pull fa-virus-slash icon To the left
...
## Pull fa-virus-slash icon To the right
...
## Animate fa-virus-slash icon using fa-spin
...
## Animate fa-virus-slash icon with steps
...
## Rotate fa-virus-slash Icon using fa-rotate-x
...
## Flip fa-virus-slash Icon using fa-flip-*
...
## Combine fa-virus-slash icon with other font awesome icons
