+++
title="Assistive Listening Systems icon in font awesome icons"
summary="Assistive Listening Systems icon represented as fa-assistive-listening-systems in font awesome icons has 1 variant fas i.e.,solid."
keywords=["fa-assistive-listening-systems,f2a2,Assistive Listening Systems"]
...
Assistive Listening Systems icon represented as fa-assistive-listening-systems in font awesome icons has 1 variant fas i.e.,solid.

<div class='table-responsive'><table class='table'><thead><tr><th>Name</th><th>Class Name</th><th>Css Content Code</th></tr></thead><tbody><tr><td>Assistive Listening Systems</td><td>fa-assistive-listening-systems</td><td>f2a2</td></tr></tbody></table></div>



## Assistive Listening Systems icon Usage

To display Assistive Listening Systems icon add predefined class name i.e.,fa-assistive-listening-systems (with prefix fa-) to the 'i' tag.
...
## Change Assistive Listening Systems icon size
To increase Assistive Listening Systems font awesome icon size, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes along with icon class fa-assistive-listening-systems.
...
## Assistive Listening Systems Icon with Fixed Width 
...
## Assistive Listening Systems Icon Border 
...
## Pull Assistive Listening Systems icon To the left
...
## Pull Assistive Listening Systems icon To the right
...
## Animate Assistive Listening Systems icon using fa-spin
...
## Animate Assistive Listening Systems icon with steps
...
## Rotate Assistive Listening Systems Icon using fa-rotate-x
...
## Flip Assistive Listening Systems Icon using fa-flip-*
...
## Combine Assistive Listening Systems icon with other font awesome icons
