...
linktitle = 'fa-money-bill-1-wave'
[menu.fontawesome]
parent = 'fontawesome'
weight = 20
draft = 'false'
...
Use the following icon SVG to display `Money-Bill-1-Wave` font awesome icon.
```
...
## Change `Money-Bill-1-Wave` font awesome icon size
